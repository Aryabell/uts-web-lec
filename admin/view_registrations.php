    ...
    <nav class="bg-gray-800 shadow-md">
        <div class="container mx-auto flex items-center justify-between p-4">
            ...
            <div class="hidden md:flex space-x-4 items-center">
                <a class="text-gray-200 hover:text-white transition duration-300">
            ...
            <!-- Burger button -->
            <button id="navbar-toggle" class="text-white hover:text-gray-200 focus:outline-none md:hidden">
                <i class="fas fa-bars"></i>
            </button>
        </div>
        <!-- Mobile menu (hidden by default) -->
        <div id="navbar-menu" class="hidden md:hidden bg-gray-800">
            <a class="block px-4 py-2 text-gray-200 hover:bg-gray-700">
                <i class="fas fa-user"></i> <?php echo htmlspecialchars($user_name); ?>
            </a>
