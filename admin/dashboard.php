    ...
    <nav class="bg-gray-800 shadow-md">
        <div class="container mx-auto flex items-center justify-between p-4">
            ...
            <div class="hidden md:flex space-x-4 items-center">
                <span class="text-gray-200 hover:text-white transition duration-300">
        ...
        <div id="navbar-menu" class="hidden md:hidden bg-gray-800">
            <a class="block px-4 py-2 text-gray-200 hover:bg-gray-700" href="#">
                <i class="fas fa-user"></i> <?php echo htmlspecialchars($user_name); ?>
            </a>
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4">
                                <img src="../uploads/<?php echo htmlspecialchars($event['banner_image']); ?>" alt="Banner" class="w-32 h-32 object-cover rounded-lg">
                            </td>
                            ...
                            <td class="px-6 py-4 text-sm">
                                ...
                                <a href="delete_event.php?id=<?= $event['id'] ?>" class="text-red-600 hover:text-red-800 font-medium transition-all duration-300" onclick="return confirm('Are you sure?')">
